                ...
                if (_user.readerAutoScrollEnabled) ...[
                  Row(
                    children: [
                      ...
                      Text(l10n.readerAutoScrollDistance, style: tt.bodyMedium),
                      const Spacer(),
                      Text(
                  ...
                  Slider(
                    ...
                    min: 0.2,
                    divisions: 16,
                    label: '${(_user.readerAutoScrollDistance * 100).round()}%',
                    onChanged: (v) {
                  ...
                  if (_user.readerAutoScrollResume) ...[
                    Row(
                      children: [
                        ...
                        const SizedBox(width: AppSpacing.sm),
                        Text(l10n.readerAutoResumeDelay, style: tt.bodyMedium),
                        const Spacer(),
                        Text(
                          l10n.readerSeconds(
